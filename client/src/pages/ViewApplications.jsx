            ...
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className="text-gray-700">
                ...
                <td className="py-2 px-4 border-b">
                  <a
                    className="bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 itema-center"
                    href=""
                    target="_blank"
                  >
                ...
                <td className="py-2 px-4 border-b relative">
                  <div className="relative inline-block text-left group">
                    ...
                    <div className="z-10 hidden absolute rigt-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block ">
